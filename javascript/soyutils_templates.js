...
/**
 * @param {function(?Object<string, *>=, ?IjData=)} fn
 * @param {?} data
 * @return {function(?Object<string, *>=, ?IjData=)}
 */
...
/**
 * @param {function(!IncrementalDomRenderer, ?Object<string, *>=, ?IjData=)} fn
 * @param {?} data
 * @return {function(!IncrementalDomRenderer, ?Object<string, *>=, ?IjData=)}
 */
