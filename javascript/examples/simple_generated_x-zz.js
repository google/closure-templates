...
soy.examples.simple.helloWorld = function(opt_data, opt_ignored, opt_ijData) {
  return soydata.VERY_UNSAFE.ordainSanitizedHtml('Zhello zworld!');
};
if (goog.DEBUG) {
...
soy.examples.simple.helloName = function(opt_data, opt_ignored, opt_ijData) {
  opt_data = opt_data || {};
  return soydata.VERY_UNSAFE.ordainSanitizedHtml((opt_data.name) ? 'Zhello ' + soy.$$escapeHtml(opt_data.name) + '!' : soy.examples.simple.helloWorld(null, null, opt_ijData));
};
if (goog.DEBUG) {
