...
# Register the custom toolchains from the local rbe_toolchain directory
register_toolchains("//rbe_toolchain/java:all")
register_toolchains("//rbe_toolchain/config:all")
