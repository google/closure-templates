...
### `list.length()` {#length} {#list-any_length}

Returns the length of a list.

Also callable as deprecated global function: `length(list)`

### `list.concat(list)` {#concatLists} {#list-any_concat}
...
### `list<number>.sort()` {#sort} {#list-number_sort}
...
### `map.keys()` {#mapKeys} {#map-any,any_keys}
...
### `str.contains(subStr)` {#strContains} {#string_contains}
...
### `str.indexOf(subStr)` {#strIndexOf} {#string_indexOf}
...
### `str.length()` {#strLen} {#string_length}
...
### `str.substring(start[, end])` {#strSub} {#string_substring}
...
### `str.toAsciiLowerCase()` {#strToAsciiLowerCase} {#string_toAsciiLowerCase}
...
### `str.toAsciiUpperCase()` {#strToAsciiUpperCase} {#string_toAsciiUpperCase}
