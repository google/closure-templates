...
`uri`                  | `com.google.common.html.types.SafeUrl`                      |
`trusted_resource_uri` | `com.google.common.html.types.TrustedResourceUrl`           |
`html`                 | `com.google.common.html.types.SafeHtml`                     |
