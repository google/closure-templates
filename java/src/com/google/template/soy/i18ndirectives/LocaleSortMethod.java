...
/**
 * Soy method for sorting a list of strings in alphabetical order, according to the user's locale.
 *
 * <p>Performs ASCII sort in the Python backend.
 */
@SoyMethodSignature(
    name = "localeSort",
...
@SoyPureFunction
public final class LocaleSortMethod
  ...
  public JavaScriptValue applyForJavaScriptSource(
    ...
    return factory.callModuleFunction(
        ...
        "$$localeSort",
        args.get(0),
        args.size() > 1 ? args.get(1) : factory.emptyObjLiteral());
  }
