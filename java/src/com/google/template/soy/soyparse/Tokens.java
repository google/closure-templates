...
final class Tokens {
  ...
  static SourceLocation createSrcLoc(SourceFilePath filePath, Token first, Token... rest) {
    ...
    return new SourceLocation(
        filePath,
        Point.create(beginLine, beginColumn),
        Point.create(endLine, endColumn),
        ByteSpan.create(beginByte, endByte));
  }
  ...
  static String getTokenDisplayName(int tokenId) {
    switch (tokenId) {
      ...
      case SoyFileParserConstants.OUTPUT_FUNCTION_OPEN:
        return "{[export ]outputfunction";
      ...
      case SoyFileParserConstants.CMD_BEGIN_WHILE:
        return "{while";
      case SoyFileParserConstants.CMD_BREAK:
        return "{break";
      case SoyFileParserConstants.CMD_CONTINUE:
        return "{continue";
