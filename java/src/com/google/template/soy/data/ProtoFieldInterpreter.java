...
public abstract class ProtoFieldInterpreter {
  ...
  static ProtoFieldInterpreter create(
    ...
    // TODO: b/373956531 - Remove this when we change 64-bit int maps to default to gbigint.
    if (fieldDescriptor.isMapField()
        && fieldDescriptor.getOptions().getExtension(Jspb.jstype) != Jspb.JsType.GBIGINT) {
