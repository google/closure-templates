...
abstract class AbstractDict extends SoyAbstractValue implements SoyDict {
   ...
   *
   * <p>The provider map doesn't need to be immutable, but will not be mutated from any of
