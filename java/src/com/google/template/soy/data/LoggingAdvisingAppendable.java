...
public abstract class LoggingAdvisingAppendable implements AdvisingAppendable {
  ...
  public abstract LoggingAdvisingAppendable appendOutputFunctionInvocation(
  ...
  public static final class CommandBuffer {
    ...
    public static CommandBuffer of(Object command) {
      return new CommandBuffer(new Object[] {command});
    }

    public static CommandBuffer of(Object... commands) {
  ...
  public static class BufferingAppendable extends LoggingAdvisingAppendable {
    ...
    private static void appendCommandToBuilder(Object command, StringBuilder builder) {
      if (command instanceof String) {
        ...
        Object result = outputFunctionCommand.fn().evalFallback();
        String value = (result != null) ? result.toString() : "";
        builder.append(escapePlaceholder(value, outputFunctionCommand.escapers()));
  ...
  static class DelegatingAppendable extends LoggingAdvisingAppendable {
    ...
    public LoggingAdvisingAppendable appendOutputFunctionInvocation(
      ...
      String value = (result != null) ? result.toString() : "";
      value = escapePlaceholder(value, escapers);
  ...
  @AutoValue
  public abstract static class OutputFunctionCommand {
    @SuppressWarnings("NonApiType") // Consistent with LoggingFunctionCommand.
    public static OutputFunctionCommand create(
    ...
    public abstract OutputFunctionInvocation fn();

    public abstract ImmutableList<Function<String, String>> escapers();

    @CanIgnoreReturnValue
    public LoggingAdvisingAppendable replayOn(LoggingAdvisingAppendable appendable)
        throws IOException {
