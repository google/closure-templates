...
public final class LengthFunction extends TypedSoyFunction
  ...
  @Override
  public Method getExternJavaMethod(List<Boxedness> boxednesses) {
    return boxednesses.get(0) == Boxedness.BOXED
        ? Methods.SOY_VALUE_LENGTH
        : Methods.COLLECTION_SIZE;
  }

  @Override
  public boolean bypassParamAdapt(int paramIndex, List<Boxedness> boxednesses) {
    return true;
  }
}
