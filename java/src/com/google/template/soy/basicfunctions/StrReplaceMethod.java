...
public final class StrReplaceMethod
  ...
  public JavaScriptValue applyForJavaScriptSource(
    ...
    return factory.callNamespaceFunction(
        "soy", "soy.$$strReplace", args.get(0), args.get(1), args.get(2));
  }

  @Override
  public PythonValue applyForPythonSource(
      PythonValueFactory factory, List<PythonValue> args, PythonPluginContext context) {
    return factory.global("runtime.str_replace").call(args.get(0), args.get(1), args.get(2));
  }
  ...
  public JavaValue applyForJavaSource(
    ...
    return factory.callStaticMethod(Methods.STR_REPLACE, args.get(0), args.get(1), args.get(2));
  }
}
