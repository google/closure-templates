...
public final class SetSizeField
  ...
  public JavaScriptValue applyForJavaScriptSource(
    ...
    return args.get(0).accessProperty("size");
  }
  ...
  public Method getExternJavaMethod(List<Boxedness> argsBoxed) {
    return argsBoxed.get(0) == Boxedness.BOXED ? Methods.SET_SIZE_FN : Methods.COLLECTION_SIZE;
  }

  @Override
  public boolean bypassParamAdapt(int paramIndex, List<Boxedness> argsBoxed) {
    return true;
  }
}
