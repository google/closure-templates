...
/** Soy function that gets the values of a map. */
@SoyMethodSignature(
    name = "values",
    baseType = "map<any, any>",
    value = @Signature(returnType = "list<any>"))
@SoyPureFunction
public final class MapValuesMethod
  ...
  private static final class Methods {
    static final Method MAP_VALUES_FN =
        JavaValueFactory.createMethod(BasicFunctionsRuntime.class, "mapValues", SoyMap.class);
  }
