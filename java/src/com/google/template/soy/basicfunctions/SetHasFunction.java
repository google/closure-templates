...
public class SetHasFunction
  ...
  private static final class Methods {
    static final Method SET_HAS_FN =
        JavaValueFactory.createMethod(SoySet.class, "contains", SoyValue.class);
  }

  @Override
  public JavaValue applyForJavaSource(
      JavaValueFactory factory, List<JavaValue> args, JavaPluginContext context) {
    return factory.callJavaValueMethod(Methods.SET_HAS_FN, args.get(0), args.get(1));
  }
}
