...
public final class StrToAsciiUpperCaseFunction extends TypedSoyFunction
  ...
  private static final class Methods {
    ...
    static final MethodRef ASCII_TO_UPPER_CASE_FN_REF = MethodRef.create(ASCII_TO_UPPER_CASE_FN);
  }
  ...
  public SoyExpression computeForJbcSrc(JbcSrcPluginContext context, List<SoyExpression> args) {
    return SoyExpression.forString(
        Methods.ASCII_TO_UPPER_CASE_FN_REF.invoke(args.get(0).unboxAs(String.class)));
  }
}
