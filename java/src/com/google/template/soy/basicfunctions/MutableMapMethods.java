...
final class MutableMapMethods {
  ...
  private static final class Methods {
    static final Method MAP_CLEAR =
        createMethod(BasicFunctionsRuntime.class, "mapClear", SoyMap.class);
    static final Method MAP_DELETE =
        createMethod(BasicFunctionsRuntime.class, "mapDelete", SoyMap.class, SoyValue.class);
    static final Method MAP_SET =
        createMethod(
            BasicFunctionsRuntime.class, "mapSet", SoyMap.class, SoyValue.class, SoyValue.class);
  }
}
