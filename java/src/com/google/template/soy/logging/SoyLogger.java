...
public interface SoyLogger {
  ...
  public abstract class LoggingAttrs {
     ...
     */
    public abstract ImmutableMap<String, String> attrs();
    ...
    public static final class Builder {
      final ImmutableMap.Builder<String, String> attrsBuilder = ImmutableMap.builder();
      ...
      public Builder addDataAttribute(String key, String value) {
        checkArgument(key.startsWith("data-"));
        checkNotNull(value);
      ...
      public LoggingAttrs build() {
        ...
        return new AutoValue_SoyLogger_LoggingAttrs(attrs);
      }
    }
  }
