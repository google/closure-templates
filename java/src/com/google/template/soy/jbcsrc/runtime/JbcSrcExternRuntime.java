...
public final class JbcSrcExternRuntime {
  ...
  public static SoyValue createOutputFunctionInvocation(
    ...
    LoggingAdvisingAppendable.OutputFunctionCommand command =
        LoggingAdvisingAppendable.OutputFunctionCommand.create(invocation, ImmutableList.of());
    LoggingAdvisingAppendable.CommandBuffer buffer =
        LoggingAdvisingAppendable.CommandBuffer.of(command);
