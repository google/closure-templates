...
import com.google.template.soy.shared.SoyJsTracker;
...
public final class RenderContext {
  ...
  private final SoyJsTracker jsTracker;
  ...
  public RenderContext(
      ...
      @Nullable SoyJsTracker jsTracker) {
  ...
  public String recordJsObjectId(String id) {
    if (jsTracker != null) {
      jsTracker.trackJsObjectId(id);
    }
    return id;
  }
  ...
  public static final class Builder {
    ...
    private SoyJsTracker jsTracker;
    ...
    @CanIgnoreReturnValue
    public Builder withJsTracker(SoyJsTracker jsTracker) {
      this.jsTracker = jsTracker;
      return this;
    }
