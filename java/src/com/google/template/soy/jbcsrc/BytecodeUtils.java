...
final class BytecodeUtils {
  private static final Method INIT = Method.getMethod("void <init>()");
   ...
   * }</pre>
   */
  static void defineDefaultConstructor(ClassVisitor visitor, TypeInfo ownerType) {
    GeneratorAdapter mg = new GeneratorAdapter(Opcodes.ACC_PUBLIC, INIT, null, null, visitor);
    Label start = mg.mark();
