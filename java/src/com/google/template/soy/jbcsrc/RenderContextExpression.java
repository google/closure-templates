...
final class RenderContextExpression extends Expression implements JbcSrcPluginContext {
  ...
  private static final MethodRef RECORD_JS_OBJECT_ID =
      MethodRef.createNonPure(RenderContext.class, "recordJsObjectId", String.class);
  ...
  Expression recordJsObjectId(String value) {
    return delegate.invoke(RECORD_JS_OBJECT_ID, constant(value));
  }
