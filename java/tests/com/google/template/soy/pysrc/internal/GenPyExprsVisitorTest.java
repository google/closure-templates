  ...
  public void testMsgWithPluralWithGender() {
    ...
    String expectedPyCode =
        "translator_impl.render_icu"
            ...
            + "if runtime.key_safe_data_access(data.get('people'),"
            + " runtime.maybe_coerce_key_to_string(###)) is None "
            + "else runtime.key_safe_data_access(data.get('people'),"
            + " runtime.maybe_coerce_key_to_string(###)).get('gender'), "
            ...
            + "'NAME_1': str(runtime.key_safe_data_access(data.get('people'),"
            + " runtime.maybe_coerce_key_to_string(###)).get('name')), "
            + "'NAME_2': str(None "
            + "if runtime.key_safe_data_access(data.get('people'),"
            + " runtime.maybe_coerce_key_to_string(###)) is None "
            + "else runtime.key_safe_data_access(data.get('people'),"
