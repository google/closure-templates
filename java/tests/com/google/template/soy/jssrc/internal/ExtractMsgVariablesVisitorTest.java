...
public final class ExtractMsgVariablesVisitorTest {
  ...
  public void testReplacement() {
    ...
    assertThat(m0.getPlaceholder(gm0p1).name()).isEqualTo("USER_NAME");
    ...
    assertThat(m0.getPlaceholder(gm0p3).name()).isEqualTo("START_LINK");
    ...
    assertThat(m0.getPlaceholder(gm0p5).name()).isEqualTo("END_LINK");
    ...
    assertThat(m2.getPlaceholder(gm2p0).name()).isEqualTo("START_SPAN");
