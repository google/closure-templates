  ...
  public void testHeaderParamFieldImport() {
    ...
    String expectedJsFileContentStart =
        "// This file was automatically generated by the Soy compiler.\n"
            ...
            + "  let $tmp = opt_data.moo && (/** @type {?} */ (opt_data.moo).$jspbMessageInstance"
            + " || opt_data.moo);\n"
            + "  /** @type {proto.example.ExampleExtendable} */\n"
            + "  const moo = soy.asserts.assertType($tmp instanceof"
            + " proto.example.ExampleExtendable, 'moo', $tmp,"
            + " 'proto.example.ExampleExtendable');\n"
            + "  return"
            + " soydata.VERY_UNSAFE.ordainSanitizedHtml(moo.getExtension(proto.example.SomeExtension.someExtensionField)"
            + " + moo.getExtension(proto.example.SomeNestedExtension.NestedExtension.someNestedExtensionField));\n"
            + "};\n"
            + "/**\n"
            + " * @typedef {{\n"
