...
public final class GenJsCodeVisitorTest {
  ...
  public void testLet() {
    ...
    String expectedJsCode =
        ""
            + "if (opt_data.boo) {\n"
            + "  let alpha__soy5 = opt_data.boo.foo;\n"
            + "  let beta__soy8 = 'Boo!';\n"
            + "  let gamma__soy18 = '';\n"
            + "  let i16ListLen = Math.max(0, Math.ceil((alpha__soy5 - 0) / 1));\n"
            + "  for (let i16Index = 0; i16Index < i16ListLen; i16Index++) {\n"
            + "    let i16Data = 0 + i16Index * 1;\n"
            + "    gamma__soy18 += i16Data + beta__soy8;\n"
            + "  }\n"
            + "  let delta__soy21 = 'Boop!';\n"
            + "  let delta__wrapped21 = soydata.VERY_UNSAFE"
  ...
  public void testIf() {
    ...
    expectedJsCode =
        ""
            ...
            + "  let i10ListLen = Math.max(0, Math.ceil((4 - 0) / 1));\n"
            + "  for (let i10Index = 0; i10Index < i10ListLen; i10Index++) {\n"
            + "    let i10Data = 0 + i10Index * 1;\n"
            + "    output += i10Data + 1 + '<br>';\n"
            + "  }\n"
            + "} else if (!soy.$$strContains('' + gooData8, 'goo')) {\n"
            + "  output += 'Bleh';\n"
  ...
  public void testBasicCall() {
    ...
    String expectedJsCode =
        ""
            + "let param11 = '';\n"
            + "let i9ListLen = Math.max(0, Math.ceil((7 - 0) / 1));\n"
            + "for (let i9Index = 0; i9Index < i9ListLen; i9Index++) {\n"
            + "  let i9Data = 0 + i9Index * 1;\n"
            + "  param11 += i9Data;\n"
            + "}\n"
  ...
  public void testMsgWithCollidingPlrsel() {
    ...
    String expectedJsCode =
        ""
            ...
            + "}"
            + "}');\n"
            + "let msg_s = new goog.i18n.MessageFormat(MSG_UNNAMED).formatIgnoringPound("
  ...
  public void testGoogModuleGeneration() {
    ...
    String expectedJsCode =
        "// This file was automatically generated by the Soy compiler.\n"
            ...
            + "goog.requireType('goog.soy');\n"
            + "goog.require('soydata.VERY_UNSAFE');\n"
            + "let $import1 = goog.require('boo.bar');\n"
            + "let $templateAlias1 = $import1.one;\n"
            + "let $templateAlias2 = $import1.two;\n"
            + "\n"
            + "\n"
            + "/**\n"
            + " * @param {?Object<string, *>=} opt_data\n"
            ...
            + " * @suppress {checkTypes}\n"
            + " */\n"
            + "let $goo = function(opt_data, opt_ijData, opt_ijData_deprecated) {\n"
            + "  opt_ijData = /** @type {!goog.soy.IjData} */ (opt_ijData_deprecated ||"
            + " opt_ijData);\n"
