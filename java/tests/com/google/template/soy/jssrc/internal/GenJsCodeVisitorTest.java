...
public final class GenJsCodeVisitorTest {
  ...
  public void testSoyFileInDelegatePackage() {
    ...
    String expectedJsFileContent =
        "// This file was automatically generated by the Soy compiler.\n"
            ...
            + "  return"
            + " soydata.VERY_UNSAFE.ordainSanitizedHtml(soy.$$getDelegateFn(soy.$$getDelTemplateId('myDelegates.soo'),"
  ...
  public void testDelegateVariantProvideRequiresJsDocAnnotations() {
    ...
    String expectedJsFileContent =
        "// This file was automatically generated by the Soy compiler.\n"
            ...
            + "  opt_ijData = /** @type {!goog.soy.IjData} */ (opt_ijData);\n"
            + "  return"
            + " soydata.VERY_UNSAFE.ordainSanitizedHtml(soy.$$getDelegateFn(soy.$$getDelTemplateId('myDelegates.moo'),"
  ...
  public void testGoogModuleGeneration() {
    ...
    String expectedJsCode =
        "// This file was automatically generated by the Soy compiler.\n"
            ...
            + "goog.require('soy');\n"
            + "goog.require('soydata.VERY_UNSAFE');\n"
            + "const $soy$boo$bar = goog.require('boo.bar');\n"
            + "\n"
            + "\n"
            + "/**\n"
            + " * @param {?Object<string, *>=} opt_data\n"
            ...
            + "  return soydata.VERY_UNSAFE.ordainSanitizedHtml($soy$boo$bar.one(null, opt_ijData)"
            + " + $soy$boo$bar.two(null, opt_ijData));\n"
            + "};\n"
            + "exports.goo = $goo;\n"
            + "if (goog.DEBUG) {\n"
            + "  /** @type {string} */\n"
  ...
  @Test
  public void callWithUnknownHtmlTemplate() {
    String testFileContent =
        ""
            + "{namespace ns}\n"
            + "\n"
            + "{template .callWithUnknownHTMLTemplate}\n"
            + "  {call .fakeTemplate /}\n"
            + "{/template}\n";
    ...
    String expectedJsCode =
        "// This file was automatically generated by the Soy compiler.\n"
            ...
            + "\n"
            + "/**\n"
            + " * @fileoverview Templates in namespace ns.\n"
            + " * @suppress {missingRequire} TODO(b/152440355)\n"
            + " * @public\n"
            + " */\n"
            + "\n"
            ...
            + "  opt_ijData = /** @type {!goog.soy.IjData} */ (opt_ijData);\n"
            + "  return"
            + " soydata.VERY_UNSAFE.ordainSanitizedHtml(soy.$$escapeHtml(ns.fakeTemplate(null,"
            + " opt_ijData)));\n"
            + "};\n"
            + "if (goog.DEBUG) {\n"
            + "  /** @type {string} */\n"
    ...
    ParseResult parseResult =
        SoyFileSetParserBuilder.forFileContents(testFileContent).runAutoescaper(true).parse();
  ...
  @Test
  public void callWithUnknownAttributeTemplate() {
    String testFileContent =
        ""
            + "{namespace ns}\n"
            + "\n"
            + "{template .callWithUnknownAttributeTemplate kind=\"attributes\"}\n"
            + "  {call .fakeTemplate /}\n"
            + "{/template}\n";
    ...
    String expectedJsCode =
        "// This file was automatically generated by the Soy compiler.\n"
            ...
            + " * @param {?Object<string, *>=} opt_data\n"
            + " * @param {(?goog.soy.IjData|?Object<string, *>)=} opt_ijData\n"
            + " * @return {!goog.soy.data.SanitizedHtmlAttribute}\n"
            + " * @suppress {checkTypes}\n"
            + " */\n"
            ...
            + "  opt_ijData = /** @type {!goog.soy.IjData} */ (opt_ijData);\n"
            + "  return"
            + " soydata.VERY_UNSAFE.ordainSanitizedHtmlAttribute(soy.$$filterHtmlAttributes(ns.fakeTemplate(null,"
            + " opt_ijData)));\n"
            + "};\n"
            + "if (goog.DEBUG) {\n"
            + "  /** @type {string} */\n"
  ...
  @Test
  public void callWithUnknownAttributeTemplateInHtml() {
    String testFileContent =
        ""
            + "{namespace ns}\n"
            + "\n"
            + "{template .callWithUnknownAttributeTemplateInHTML}\n"
            + "  <div {call .fakeTemplate /}></div>\n"
            + "{/template}\n";
