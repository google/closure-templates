  ...
  public void testExpressions() throws Exception {
    assertSourceRanges(
        JOINER.join(
            ...
            "              VarRefNode       $b",
            "          VarRefNode           $c",
            "    PrintNode                  {$l[$a * $b] < $c && not [...] ($b ? length($l) : $c)}",
            "      ExprRootNode             $l[$a * $b] < $c && not $[...]? ($b ? length($l) : $c)",
            "        NullCoalescingOpNode   $l[$a * $b] < $c && not $[...]? ($b ? length($l) : $c)",
            "          AmpAmpOpNode         $l[$a * $b] < $c && not $l?[$c]",
