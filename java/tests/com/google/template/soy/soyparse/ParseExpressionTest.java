...
public final class ParseExpressionTest {
  ...
  public void testParsePrimitives() throws Exception {
    ...
    assertThat(((NumberNode) expr).longValue()).isEqualTo(26);

    expr = assertThatExpression("0xCAFE").isValidExpression();
    assertThat(((NumberNode) expr).longValue()).isEqualTo(0xCAFE);

    expr = assertThatExpression("3.14").isValidExpression();
    assertThat(((NumberNode) expr).doubleValue()).isEqualTo(3.14);

    expr = assertThatExpression("3e-3").isValidExpression();
    assertThat(((NumberNode) expr).doubleValue()).isEqualTo(3e-3);
  ...
  public void testParseFunctionCall() throws Exception {
    ...
    assertThat(((NumberNode) roundFn.getChild(0)).doubleValue()).isEqualTo(3.14159);
    assertThat(((NumberNode) roundFn.getChild(1)).longValue()).isEqualTo(2);
  }
  ...
  public void testParseProtoInitCall() throws Exception {
    ...
    assertThat(((NumberNode) protoFn.getChild(1)).longValue()).isEqualTo(1);
  ...
  public void testParseOperators() throws Exception {
    ...
    assertThat(negInt.longValue()).isEqualTo(-11);
    ...
    assertThat(((NumberNode) minusOp.getChild(0)).longValue()).isEqualTo(90);
    assertThat(((NumberNode) minusOp.getChild(1)).doubleValue()).isEqualTo(14.75);
