...
public final class DesugarGroupNodesPassTest {
  ...
  public void testDesugarGroupNodesFromTemplate_multipleSubExprs() {
    ...
    assertThat(((NumberNode) plusOpNode.getChild(0)).getValue()).isEqualTo(1D);
    assertThat(((NumberNode) plusOpNode.getChild(1)).getValue()).isEqualTo(5D);
    assertThat(((NumberNode) timesOpNode.getChild(1)).getValue()).isEqualTo(6D);
    assertThat(((NumberNode) divideOpNode.getChild(1)).getValue()).isEqualTo(2D);
  }
