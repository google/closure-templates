...
+ SoyMsgExtractor.jar
    Executable jar that extracts messages from template files. For
    translation/localization.


Instructions:

+ Documentation for translation support:
    http://code.google.com/closure/templates/docs/translation.html
